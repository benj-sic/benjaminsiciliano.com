// This file is generated by scripts/filter_emory_network.js
...
const nodes = [
  ...
  },
  {
    ...
    "keyPersonnel": [
      ...
      {
        "name": "Mike Natchus",
        "linkedin": "https://www.linkedin.com/in/mike-natchus-26424625/"
      },
      {
        "name": "Alexander Kolykhalov",
        "linkedin": "https://www.linkedin.com/in/alexanderkolykhalov/"
      },
      {
        "name": "Dana Schneider",
        "linkedin": "https://www.linkedin.com/in/dana-schneider-abb18a43/"
      },
      {
        "name": "Marcus Rodriguez",
        "linkedin": "https://www.linkedin.com/in/marcus-rodriguez-9269282/"
      }
    ],
...
const links = [
  {
    ...
    "target": "gatech",
    "type": "collaboration",
    "description": "Joint Coulter Department of Biomedical Engineering"
  },
  {
    "source": "emory",
    "target": "gsu",
    "type": "collaboration",
    "description": "NIH Antivirals Center (AC/DC)"
  },
  {
    "source": "emory",
    "target": "morehouse",
    "type": "collaboration",
    "description": "Georgia CTSA Alliance"
  },
  {
    "source": "gatech",
    "target": "morehouse",
  ...
  },
  {
    ...
    "target": "cdc",
    "type": "collaboration",
    "description": "Numerous research partnerships"
  },
  {
    "source": "emory",
    "target": "choa",
    "type": "collaboration",
    "description": "Academic partner in pediatric research and clinical training"
  },
  {
    "source": "gatech",
    "target": "choa",
    "type": "collaboration",
    "description": "Collaborates on pediatric medtech and translational research"
  },
  {
    "source": "emory",
    "target": "emory_healthcare",
    "type": "affiliation",
    "description": "Clinical enterprise of Emory University; partner for translational and digital health research"
  },
  {
    "source": "emory_healthcare",
    "target": "florence",
    "type": "pilot",
    "description": "Florence's eClinical tools validated in Emory Healthcare Innovation Hub pilot programs"
  },
  {
    "source": "switchboard_md",
    "target": "emory_healthcare",
    "type": "pilot",
    "description": "Partnered with Emory Healthcare to implement and validate clinical operations and AI workflow tools"
  },
  {
    "source": "switchboard_md",
    "target": "emory",
    "type": "collaboration",
    "description": "Founded by Emory-affiliated physicians and collaborates on applied AI and clinical operations research"
  },
  {
    "source": "emory",
    "target": "grady",
    "type": "collaboration",
    "description": "Emory partners with Grady for clinical care, research, and workforce development"
  },
  {
    "source": "morehouse",
    "target": "grady",
    "type": "collaboration",
    "description": "Morehouse School of Medicine is a core academic partner at Grady"
  },
  {
    "source": "georgia_ctsa",
    "target": "emory",
    "type": "collaboration",
    "description": "Core CTSA partner leading clinical trials infrastructure and translational science programs."
  },
  {
    "source": "georgia_ctsa",
    "target": "gatech",
    "type": "collaboration",
    "description": "Georgia Tech co-leads Georgia CTSA efforts in device development, data science, and commercialization support."
  },
  {
    "source": "georgia_ctsa",
    "target": "morehouse",
    "type": "collaboration",
    "description": "Partner in CTSA community engagement, clinical trial access, and translational research training."
  },
  {
    "source": "georgia_ctsa",
    "target": "gsu",
    "type": "collaboration",
    "description": "Contributes public health and behavioral science expertise to statewide CTSA programs."
  },
  {
    "source": "georgia_ctsa",
    "target": "grady",
    "type": "infrastructure",
    "description": "Operates clinical research units within Grady for translational and population health research."
  },
  {
    "source": "georgia_ctsa",
    "target": "choa",
    "type": "infrastructure",
    "description": "Supports pediatric clinical research infrastructure at CHOA sites."
  },
  {
    "source": "department_of_veterans_affairs",
    "target": "emory",
    "type": "collaboration",
    "description": "Joint clinical research, many dual-appointed physician-scientists, major partner in translational medicine and clinical trials."
  },
  {
    "source": "department_of_veterans_affairs",
    "target": "morehouse",
    "type": "collaboration",
    "description": "NIH-funded clinical and translational science, joint community health studies as part of Georgia CTSA."
  },
  {
    "source": "department_of_veterans_affairs",
    "target": "gatech",
    "type": "collaboration",
    "description": "Device testing, digital health, and engineering partnerships on medtech pilots and translational projects."
  },
  {
    "source": "department_of_veterans_affairs",
    "target": "georgia_ctsa",
    "type": "affiliation",
    "description": "Formal affiliate of the Georgia Clinical & Translational Science Alliance (Georgia CTSA), Atlanta's NIH translational research consortium."
  },
  {
    "source": "nucleate_atlanta",
    "target": "gatech",
    "type": "collaboration",
    "description": "Nucleate Atlanta recruits founders and fellows from Georgia Tech graduate programs."
  },
  {
    "source": "nucleate_atlanta",
    "target": "emory",
    "type": "collaboration",
    "description": "Nucleate Atlanta partners with Emory students, postdocs, and faculty to launch biotech ventures."
  },
  {
    "source": "nucleate_atlanta",
    "target": "uga",
    "type": "collaboration",
    "description": "UGA students participate in Nucleate Atlanta's Activator and fellowship programs."
  },
  {
    "source": "nucleate_atlanta",
    "target": "gsu",
    "type": "collaboration",
    "description": "Georgia State students participate in Nucleate's regional cohort for Atlanta-based life sciences innovation."
  },
  {
    "source": "gsu",
    "target": "collabtech_gsu",
    "type": "infrastructure",
    "description": "CollabTech is Georgia State University's life sciences incubator providing lab space and core research facilities."
  },
  {
    "source": "emory",
    "target": "eidd",
    "type": "infrastructure",
    "description": "EIDD is a drug discovery and translational research center established and operated by Emory University."
  },
  {
    "source": "emory",
    "target": "adjust_center_emory",
    "type": "infrastructure",
    "description": "Emory University operates the ADJUST Center, housing translational diagnostics labs and equity‑focused assay development capabilities."
  },
  {
    "source": "emory",
    "target": "geovax",
    "type": "spinout",
    "description": "Technology developed at Emory"
  },
  {
    "source": "emory",
    "target": "neurop",
    "type": "spinout",
    "description": "Founded by Emory faculty"
  },
  {
    "source": "emory",
    "target": "altesa",
    "type": "spinout",
    "description": "Formed via Emory's DRIVE institute"
  },
  {
    "source": "emory",
    "target": "braintrust",
  ...
  },
  {
    ...
    "target": "topodx",
    "type": "spinout",
    "description": "Co-founded by Emory and GT researchers"
  },
  {
    "source": "emory",
    "target": "cambium_oncology",
    "type": "spinout",
    "description": "Founded on IP licensed from Emory University; works closely with Winship Cancer Institute"
  },
  {
    "source": "gatech",
    "target": "sanguina",
    "type": "spinout",
    "description": "Co-founded by GT alumna from student research"
  },
  {
    "source": "sanguina",
    "target": "emory",
    "type": "spinout",
    "description": "Georgia Tech / Emory research spinout—AnemoCheck platform developed with Wilbur Lam (Emory/GT) and clinically validated using Emory patient data."
  },
  {
    "source": "gatech",
    "target": "topodx",
    "type": "spinout",
    "description": "Developed out of Georgia Tech research"
  },
  {
    "source": "gatech",
    "target": "metaclipse",
    "type": "spinout",
    "description": "Founded by Georgia Tech researchers; based on VLP platform technology developed at GT."
  },
  {
    "source": "gatech",
    "target": "andson_biotech",
    "type": "spinout",
    "description": "Georgia Tech spinout commercializing DynaChip™ microfluidic technology."
  },
  {
    "source": "emory",
    "target": "metaclipse",
    "type": "collaboration",
    "description": "Emory-affiliated advisors and founders contribute scientific expertise to VLP platform development."
  },
  {
    "source": "portal",
    "target": "topodx",
    "type": "investment",
    "description": "Portfolio company advancing AI-driven AST diagnostics"
  },
  {
    "source": "eddf",
    "target": "allonix",
    "type": "investment",
    "description": "EDDF portfolio investment in IBD therapeutics"
  },
  {
    "source": "eddf",
    "target": "agrithera",
    "type": "investment",
    "description": "EDDF portfolio investment in cannabinoid neurotherapeutics"
  },
  {
    "source": "gra_fund",
    "target": "geovax",
    "type": "investment",
    "description": "GeoVax is in the GRA Venture Fund portfolio"
  },
  {
    "source": "atdc",
    "target": "gatech",
    "type": "affiliation",
    "description": "Program of Georgia Tech"
  },
  {
    "source": "atdc",
    "target": "sanguina",
    "type": "support",
    "description": "Incubated at ATDC (alumni)"
  },
  {
    "source": "biolocity",
    "target": "sanguina",
    "type": "support",
    "description": "Received early grant funding"
  },
  {
    "source": "biolocity",
    "target": "andson_biotech",
    "type": "support",
    "description": "Received translational funding and startup support from Biolocity."
  },
  {
    "source": "emory",
    "target": "ebfi",
    "type": "affiliation",
    "description": "Hosted and operated by Emory University"
  },
  {
    "source": "emory",
    "target": "eddf",
    "type": "affiliation",
    "description": "Part of Emory Innovations, Inc."
  },
  {
    "source": "emory",
    "target": "drive",
    "type": "affiliation",
    "description": "Emory-formed drug development accelerator for antiviral therapeutics"
  },
  {
    "source": "drive",
    "target": "eddf",
    "type": "origin",
    "description": "Established EDDF using royalties from DRIVE-licensed drug molnupiravir (LAGEVRIO)"
  },
  {
    "source": "drive",
    "target": "altesa",
    "type": "spinout",
    "description": "Antiviral spinout formed via DRIVE to develop Vapendavir and other respiratory virus therapies"
  },
  {
    "source": "drive",
    "target": "agrithera",
    "type": "funded_by",
    "description": "Supported preclinical work on cannabinoid-based neurotherapeutics"
  },
  {
    "source": "gatech",
    "target": "science_square",
    "type": "development",
    "description": "Development partner (via GATV)"
  },
  {
    "source": "emory",
    "target": "science_square",
    "type": "housed_at",
    "description": "Seven Emory labs relocating to Science Square (2025)"
  },
  {
    "source": "science_square",
    "target": "portal",
    "type": "tenant",
  ...
  },
  {
    ...
    "description": "Co-leads the Emory x Portal Innovation Certificate Program to train faculty and clinicians in biotech commercialization"
  },
  {
    "source": "portal",
    "target": "oncospherix",
    "type": "member",
    "description": "OncoSpherix is a Portal Atlanta member company."
  },
  {
    "source": "accuitis",
    "target": "emory",
    "type": "spinout",
    "description": "Accuitis Pharmaceuticals key technology was discovered by Emory University."
  },
  {
    "source": "accuitis",
    "target": "gra",
    "type": "program",
    "description": "Accuitis is a participant in the Georgia Research Alliance Venture Lab program."
  },
  {
    "source": "diasyst",
    "target": "emory",
    "type": "collaboration",
    "description": "Diasyst is backed by decades of research at Emory University and the VA."
  },
  {
    "source": "diasyst",
    "target": "gra",
    "type": "funding",
    "description": "Diasyst received GRA funding in 2019."
  },
  {
    "source": "earlitec",
    "target": "emory",
    "type": "collaboration",
    "description": "EarliTec Diagnostics collaborates with Emory University on autism research and clinical validation studies."
  },
  {
    "source": "kodikaz",
    "target": "emory",
    "type": "collaboration",
    "description": "Kodikaz Therapeutics collaborates with Emory University on gene therapy research. Co-Founder Dr. Leon Bernal-Mizrachi is Associate Professor in the Department of Hematology and Medical Oncology at Emory University School of Medicine."
  },
  {
    "source": "nyra_medical",
    "target": "emory",
    "type": "spinout",
    "description": "Nyra Medical was founded in 2021 based on intellectual property developed at Emory University by Dr. Murali Padala. The company licensed its core CARLEN technology from Emory University."
  },
  {
    "source": "gra_fund",
    "target": "accuitis",
    "type": "investment",
    "description": "Accuitis is a GRA Venture Fund portfolio company developing dermatology drugs for rosacea."
  },
  {
    "source": "gra_fund",
    "target": "diasyst",
    "type": "investment",
    "description": "Diasyst is a GRA Venture Fund portfolio company developing chronic disease management tools."
  },
  {
    "source": "gra_fund",
    "target": "earlitec",
    "type": "investment",
    "description": "EarliTec Diagnostics is a GRA Venture Fund portfolio company developing early diagnosis tools for autism and developmental disorders."
  },
  {
    "source": "gra_fund",
    "target": "kodikaz",
    "type": "investment",
    "description": "Kodikaz is a GRA Venture Fund portfolio company developing gene therapies for cancer."
  },
  {
    "source": "gra_fund",
    "target": "nyra_medical",
    "type": "investment",
    "description": "Nyra Medical is a GRA Venture Fund portfolio company developing transcatheter mitral valve repair technology."
  },
  {
    "source": "gra_fund",
    "target": "sanguina",
    "type": "investment",
    "description": "Sanguina is a GRA Venture Fund portfolio company developing hemoglobin testing via smartphone (AnemoCheck)."
  },
  {
    "source": "biolocity",
    "target": "emory",
    "type": "collaboration",
    "description": "Joint program with Emory"
  },
  {
    "source": "biolocity",
    "target": "gatech",
    "type": "collaboration",
    "description": "Joint program with Georgia Tech"
  },
  {
    "source": "biolocity",
    "target": "lab2launch",
    "type": "support",
    "description": "Biolocity subsidizes and guides startups in Lab2Launch, includes programmatic support and consultation."
  },
  {
    "source": "emory",
    "target": "lab2launch",
    "type": "infrastructure",
    "description": "Lab2Launch located onsite at Emory's HSRB II Innovation Floor; supports Emory-affiliated innovators."
  },
  {
    "source": "emory_ott",
    "target": "emory",
    "type": "affiliation",
    "description": "Office of Technology Transfer is Emory's formal commercialization & IP licensing arm."
  },
  {
    "source": "emory_ott",
    "target": "biolocity",
    "type": "collaboration",
    "description": "OTT collaborates with Biolocity to connect researchers to commercialization funding and support programs."
  },
  {
    "source": "gatech",
    "target": "quadrant_i",
    "type": "affiliation",
    "description": "Quadrant-i is a Georgia Tech commercialization and venture creation unit accelerating research translation into startups."
  },
  {
    "source": "quadrant_i",
    "target": "biolocity",
    "type": "collaboration",
    "description": "Quadrant-i Principals advise Biolocity projects and help connect funded teams to investors and partners."
  },
  {
    "source": "quadrant_i",
    "target": "emory",
    "type": "collaboration",
    "description": "Collaborates on Emory-affiliated Biolocity projects such as Infinite Loupe and OnCuRNA."
  },
  {
    "source": "quadrant_i",
    "target": "oncurna",
    "type": "support",
    "description": "Assisted Georgia Tech researchers in forming OnCuRNA, focused on solid tumor RNAi therapeutics."
  },
  {
    "source": "biolocity",
    "target": "oncurna",
    "type": "support",
    "description": "Biolocity-supported startup selected in 2025-26 cohort for ovarian cancer drug delivery platform, receiving mentorship and non-dilutive funding."
  },
  {
    "source": "biolocity",
    "target": "cambium_oncology",
    "type": "support",
    "description": "Biolocity portfolio company developing precision oncology therapeutics based on Emory research."
  },
  {
    "source": "biolocity",
    "target": "metaclipse",
    "type": "support",
    "description": "Biolocity portfolio company developing VLP vaccine platform technology from Georgia Tech research."
  },
  {
    "source": "biolocity",
    "target": "dr_noze_best",
    "type": "support",
    "description": "Biolocity portfolio company developing pediatric health and wellness solutions including the NozeBot nasal aspirator."
  },
  {
    "source": "biolocity",
    "target": "codoxo",
    "type": "support",
    "description": "Biolocity portfolio company developing AI-powered healthcare payment integrity and fraud detection solutions."
  },
  {
    "source": "atdc",
    "target": "dr_noze_best",
    "type": "funding",
    "description": "ATDC-funded company developing pediatric health and wellness solutions including the NozeBot nasal aspirator."
  },
  {
    "source": "gatech",
    "target": "venturelab",
    "type": "affiliation",
    "description": "VentureLab is Georgia Tech's startup launch and commercialization support hub."
  },
  {
    "source": "venturelab",
    "target": "quadrant_i",
    "type": "collaboration",
    "description": "VentureLab works upstream of Quadrant-i to identify and nurture promising tech transfer opportunities."
  },
  {
    "source": "venturelab",
    "target": "biolocity",
    "type": "collaboration",
    "description": "Refers high-potential GT teams to Biolocity for translational medtech support and funding."
  },
  {
    "source": "gatech",
    "target": "cambium_oncology",
    "type": "research_collaboration",
    "description": "Georgia Tech bioengineering and drug manufacturing support"
  },
  {
    "source": "department_of_veterans_affairs",
    "target": "diasyst",
    "type": "collaboration",
    "description": "Clinical implementation and validation of diabetes management software, building on joint Emory/VA research."
  },
  {
    "source": "biotechexec",
    "target": "biolocity",
    "type": "service",
    "description": "Mentorship and strategic consulting"
  },
  {
    "source": "mng_labs",
    "target": "emory",
    "type": "service",
    "description": "Neurogenetic testing services vendor"
  },
  {
    "source": "woven_health_collective",
    "target": "emory_healthcare",
    "type": "collaboration",
    "description": "Strategic partner to the Emory Healthcare Innovation Hub, enabling clinical UX testing and healthcare product validation"
  },
  {
    "source": "vizzia",
    "target": "choa",
    "type": "service",
    "description": "Selected by CHOA to deploy RTLS and asset tracking for Arthur M. Blank Hospital (2025)."
  },
  {
    "source": "vizzia",
    "target": "grady",
    "type": "service",
    "description": "Implemented RTLS and environmental monitoring system at Correll Pavilion (10-story surgical center)."
  },
  {
    "source": "rimidi",
    "target": "emory_healthcare",
    "type": "pilot",
    "description": "Partnered with Emory Healthcare to deploy digital treatment apps supporting personalized care."
  },
  {
    "source": "gra",
    "target": "emory",
    "type": "funding",
    "description": "Supports Emory through endowed chairs, translational research, and startup formation funding."
  },
  {
    "source": "gra",
    "target": "gatech",
    "type": "funding",
    "description": "Funds Georgia Tech research translation and startup formation; GRA Scholars often hosted here."
  },
  {
    "source": "gra",
    "target": "uga",
    "type": "funding",
    "description": "Supports innovation and entrepreneurship across UGA's pharmacy, agbio, and veterinary programs."
  },
  {
    "source": "gra",
    "target": "morehouse",
    "type": "funding",
    "description": "Partners in Georgia CTSA and supports research infrastructure at Morehouse."
  },
  {
    "source": "gra",
    "target": "gsu",
    "type": "funding",
    "description": "Supports infectious disease and neuro research; GRA Scholars hosted at Georgia State."
  },
  {
    "source": "gra",
    "target": "gra_fund",
    "type": "affiliation",
    "description": "GRA Venture Fund is the investment arm of the Georgia Research Alliance, supporting university-affiliated startups with seed-stage capital."
  },
  {
    "source": "gra",
    "target": "altesa",
    "type": "funding",
    "description": "GRA supported Emory DRIVE institute underlying Altesa's antiviral research."
  },
  {
    "source": "gra",
    "target": "allonix",
    "type": "funding",
    "description": "Backed Emory IP and early preclinical studies through GRA-sponsored programs."
  },
  {
    "source": "gra",
    "target": "cambium_oncology",
    "type": "funding",
    "description": "Supported foundational cancer research programs at Emory that seeded Cambium."
  },
  {
    "source": "gra",
    "target": "andson_biotech",
    "type": "funding",
    "description": "Received early translational support from Georgia Research Alliance."
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "emory",
    "type": "affiliation",
    "description": "EBCC is a student-led commercialization and consulting program founded at Emory University under the Innovate@Emory initiative."
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "emory_ott",
    "type": "collaboration",
    "description": "Partners with Emory OTT to support technology assessments and connect student teams to Emory-affiliated startups."
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "biolocity",
    "type": "collaboration",
    "description": "Collaborates with Biolocity to provide commercialization strategy support for early-stage medtech projects."
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "gra",
    "type": "collaboration",
    "description": "Engages with Georgia Research Alliance through university commercialization programs and startup diligence efforts."
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "switchboard_md",
    "type": "service",
    "description": "EBCC Spring 2024 client - provided commercialization strategy for AI-based triage platform"
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "emtherapro",
    "type": "service",
    "description": "EBCC Fall 2023 client - provided commercialization strategy for proteomics platform"
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "fibronox",
    "type": "service",
    "description": "EBCC Spring 2022 client - provided commercialization strategy for fibrotic disease therapeutics"
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "metaclipse",
    "type": "service",
    "description": "EBCC Spring 2020 client - provided commercialization strategy for cancer immunotherapy platform"
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "cambium_oncology",
    "type": "service",
    "description": "EBCC Fall 2019 client - provided commercialization strategy for immuno-oncology therapeutics"
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "oncospherix",
    "type": "service",
    "description": "EBCC Spring 2019 client - provided commercialization strategy for oncology drug development"
  },
  {
    "source": "emory_biotech_consulting_club",
    "target": "nyra_medical",
    "type": "service",
    "description": "EBCC Spring 2020 client - provided commercialization strategy for cardiac device technology"
  },
  {
    "source": "eddf",
    "target": "emory",
    "type": "funding",
    "description": "Direct laboratory investment in CFTR-targeted therapies via Sorscher Lab"
  },
  {
    "source": "andson_biotech",
    "target": "collabtech_gsu",
    "type": "tenant",
    "description": "Andson Biotech is a current tenant at CollabTech incubator, developing DynaChip™ microfluidic technology."
  },
  {
    "source": "neurop",
    "target": "collabtech_gsu",
    "type": "graduate",
    "description": "NeurOp is a CollabTech graduate, having incubated at Georgia State University's biotech incubator before advancing to clinical-stage CNS drug development."
  },
  {
    "source": "emtherapro",
    "target": "emory",
    "type": "spinout",
    "description": "Emory spinout transforming diagnosis and treatment of neurodegenerative diseases through pioneering science, data and insights."
  },
  {
    "source": "arc_proteomics",
    "target": "emory",
    "type": "spinout",
    "description": "Emory spinout located in Decatur, GA specializing in proteome-wide assays for biomarker discovery."
  },
  {
    "source": "tether_therapeutics",
    "target": "gatech",
    "type": "spinout",
    "description": "Tether Therapeutics technology based on novel chemistry developed at Georgia Tech, developing biodegradable polymeric nanoparticles for aerosol gene delivery to treat respiratory diseases."
  },
  {
    "source": "tether_therapeutics",
    "target": "emory",
    "type": "spinout",
    "description": "Tether Therapeutics technology based on novel chemistry developed at Emory University, creating next-generation delivery solutions for mRNA therapeutics targeting respiratory diseases."
  },
  {
    "source": "youngheartvalve",
    "target": "emory",
    "type": "collaboration",
    "description": "YoungHeartValve collaborates with Emory-affiliated cardiovascular surgeons including Vinod Thourani, MD of Piedmont Heart Institute, for clinical validation of next-generation heart valve technology."
  },
  {
    "source": "veranex",
    "target": "science_square",
    "type": "tenant",
    "description": "Veranex operates T3 Labs facility in Science Square, Atlanta's growing life sciences hub."
  },
  {
    "source": "veranex",
    "target": "cdc",
    "type": "collaboration",
    "description": "Strategic community relationship with CDC for preclinical research and public health initiatives."
  },
  {
    "source": "veranex",
    "target": "emory",
    "type": "collaboration",
    "description": "Strategic community relationship with Emory University for preclinical research and medical device development."
  },
  {
    "source": "veranex",
    "target": "gatech",
    "type": "collaboration",
    "description": "Strategic community relationship with Georgia Tech for preclinical research and medical device development."
  },
  {
    "source": "youngheartvalve",
    "target": "veranex",
    "type": "service",
    "description": "YoungHeartValve located at T3 Labs facility (now part of Veranex) for preclinical testing and development support."
  },
  {
    "source": "jackson_medical",
    "target": "emory_healthcare",
    "type": "partnership",
    "description": "Jackson Medical's GloShield™ surgical safety device is used in healthcare systems including Emory Healthcare to prevent fiber-optic cable fires and burns in operating rooms."
  },
  {
    "source": "rowen",
    "target": "uga",
    "type": "partnership",
    "description": "University of Georgia is a key academic partner in Rowen Foundation's 2,000-acre knowledge community focused on biotech, agriculture, and environmental tech."
  },
  {
    "source": "rowen",
    "target": "emory",
    "type": "partnership",
    "description": "Emory University collaborates with Rowen Foundation on biotech and environmental research initiatives in the 2,000-acre innovation district."
  },
  {
    "source": "rowen",
    "target": "gatech",
    "type": "partnership",
    "description": "Georgia Tech partners with Rowen Foundation on technology development and commercialization initiatives in the knowledge community."
  },
  {
    "source": "gra_fund",
    "target": "earlitec",
