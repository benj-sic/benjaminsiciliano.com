...
const NetworkVisualization = () => {
  ...
  useEffect(() => {
    ...
    const links = zoomGroup.append("g")
      ...
      .attr("class", d => `link ${selectedEdge && selectedEdge.source.id === d.source.id && selectedEdge.target.id === d.target.id ? 'link-highlighted' : ''}`)
